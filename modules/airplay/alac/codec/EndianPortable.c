...
// Upstream's original i386/x86_64/Win32 checks miss every other little-endian
// target, xtensa (ESP32) included: none of those macros are defined here, so
// TARGET_RT_LITTLE_ENDIAN fell through undefined (== 0, "big endian") below,
// and every Swap*NtoB/Swap*BtoN call below silently became a no-op instead of
// a byte swap on this chip. GCC/Clang both define __BYTE_ORDER__ universally,
// so this catches xtensa (and anything else little-endian) correctly.
#define TARGET_RT_LITTLE_ENDIAN 1
#endif
